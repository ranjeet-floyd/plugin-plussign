...
public class EmptyStringTokenFilter extends TokenFilter {
     ...
     * PositionIncrementAttribute object to store the position increment of the
     * token. Lucene
     * uses this latter attribute to determine the position of a token. Given a
     * token stream with
     * “This”, “is”, “”, “some”, and “text”, we are going to ensure that “This”
     * is saved at
     * position 1, “is” at position 2, “some” at position 3, and “text” at
     * position 4. Note that
     * we have completely ignored the empty string at what was position 3 in the
     * original stream.
     */
     ...
     * incrementToken()
     * function to save the attributes of the current token. We are going to
     * pass over any
     * tokens that are empty strings and save all others without modifying them.
     * This function
     * should return true if a new token was generated and false if the last
     * token was passed.
     */
    @Override
